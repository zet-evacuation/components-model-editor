...
public class JZoomableRuler extends JRuler implements ChangeListener {
    ...
    /**
     * Handles Swing events sent to the floor. Components adding some of the
     * displaying styles of the floor can send their events to the
     * {@code JFloor} class directly.
     * <p>
     * The possibility to handle events sent by slider events is implemented.
     * The slider needs to have positive values (0 is not allowed, though). A
