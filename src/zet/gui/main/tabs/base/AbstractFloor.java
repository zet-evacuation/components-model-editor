...
public class AbstractFloor extends JPanel {
    ...
    public AbstractFloor(FloorViewModel floorModel, GraphicsStyle graphicsStyle) {
        ...
        reloadValues();
        floorMin_x = defaultArea.x;
        floorMin_y = defaultArea.y;
        floorMax_x = defaultArea.x + defaultArea.width;
        floorMax_y = defaultArea.y + defaultArea.height;
    }
    ...
    public void updateOffsets(FloorViewModel floor) {
        ...
        floorMax_x = Math.max(defaultArea.x + defaultArea.width, floorPosition.x + floorPosition.width);
    ...
    public Point getMaxCoordinate() {
        ...
        return new Point(min.x + (floorMax_x - floorMax_x) + graphicsStyle.getBorderWidth(),
                min.y + (floorMax_y - floorMin_y) + graphicsStyle.getBorderWidth());
    }
