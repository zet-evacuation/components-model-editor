 ...
 *
 * There are two types of methods that this class offers. The zoom- and zoomInverse-methods <i>scale</i> the object that
 * is given to them to screen size, whereas the translateToScreen / translateToModel methods first
 * <i>copy</i> the given parameter object, <i>translate</i> it to the screen coordinate origin and then apply the
 * appropriate zoom-method.
 *
...
public class CoordinateTools {
    ...
    /**
     * Inverse method for {@link CoordinateTools#zoom(double)}. Except for rounding faults
     * {@code zoomInverse (zoom (x)) == x} should hold true.
     *
     * @param val
     * @return
     */
