...
public class PlanImage {
    ...
    /**
     * <p>
     * Sets the alpha value for the image. The values can be within 0 and 1, 0 means that the image is displayed fully
     * transparent, where a value of 1 represents no transparency.</p>
     * <p>
     * Values less than 0 or greater than 1 are ignored, note that no exception is thrown.</p>
     *
    ...
    /**
     * Returns the width on screen, using the current zoom factor. See more at {@link CoordinateTools}
     *
     * @return the width
     */
    public int getWidth() {
    ...
    /**
     * Returns the height on screen, using the current zoom factor. See more at {@link CoordinateTools}
     *
     * @return the height
     */
